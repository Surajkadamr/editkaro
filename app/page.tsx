...
export default function Page() {
    ...
    const portfolioItems = [
        ...
        },
        {
            ...
            thumbnail: 'https://assets.zeezest.com/blogs/PROD_Tigers-banner_1627364273920.jpg',
            videoUrl: 'https://www.youtube.com/embed/5O0YDHiosD0',
            description:
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
            ...
            >
                <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-black/70 z-10 left-[1280px] top-[270px]"></div>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-gray-800 rounded-xl overflow-hidden shadow-xl">
                            ...
                            <div className="absolute bottom-0 left-0 p-6">
                                <h3 className="text-xl font-bold mb-2">Our Editing Studio</h3>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white">contact@editkaro.in</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <svg
